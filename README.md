...
[![Github All Releases](https://img.shields.io/github/downloads/norainacloud/goofys/total.svg)](https://github.com/norainacloud/goofys/releases/)
...
* On Linux, install via [pre-built binaries](https://github.com/norainacloud/goofys/releases/latest/download/goofys). You may also need to install fuse-utils first.
...
See also: [Instruction for Azure Blob Storage, Azure Data Lake Gen1, and Azure Data Lake Gen2](https://github.com/norainacloud/goofys/blob/master/README-azure.md).

Got more questions? Check out [questions other people asked](https://github.com/norainacloud/goofys/issues?utf8=%E2%9C%93&q=is%3Aissue%20label%3Aquestion%20)
...
[bench.sh](https://github.com/norainacloud/goofys/blob/master/bench/bench.sh). [Raw data](https://github.com/norainacloud/goofys/blob/master/bench/)
...
See also: [cached benchmark result](https://github.com/norainacloud/goofys/blob/master/bench/cache/README.md) and [result on Azure](https://github.com/norainacloud/goofys/blob/master/bench/azure/README.md).
