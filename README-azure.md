...
Configure your credentials the same way as [Azure Blob Storage](https://github.com/norainacloud/goofys/blob/master/README-azure.md#azure-blob-storage) above, and then:
